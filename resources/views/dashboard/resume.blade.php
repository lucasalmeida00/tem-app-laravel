    ...
    <main class="tem-resume-page">
        <div class="container d-flex flex-column gap-5">
            ...
            <div class="resume-hero-card">
                ...
                <div class="tem-actions mt-2">
                    <button class="btn-tem" id="btnDownloadReport">
            ...
            <div class="summary-section">
                <h2 class="resume-section-title">Descrição do Empreendimento</h2>
            ...
            <section class="resume-section">
                <h2 class="resume-section-title">Linha do tempo</h2>
            ...
            <section class="resume-section">
                <h2 class="resume-section-title">Modelo de Negócios</h2>
                ...
                $labels = [
                    ...
                    'suporte_24_7' => 'Suporte disponível 24 horas por dia, 7 dias por semana.',
                ...
                // Helper para montar lista a partir de prefixo + índice sequencial
                ...
                $vpProblem = $card7['vpProblem'] ?? null;
                ...
                $fontesReceitaParte1 = $collectSeq($card11, 'revSource', 10);
                $fontesReceitaParte2 = $collectSeq($card11, 'monetModel', 10);
                @endphp
                ...
                <div class="bmodel-board">
                    ...
                    <div class="bmodel-top">
                        ...
                        <div class="bmodel-cell">
                            <div class="bmodel-header bmodel-header-partners">
                        ...
                        <div class="bmodel-cell bmodel-cell-split border-start">
                            ...
                            <div class="bmodel-cell-half">
                                <div class="bmodel-header bmodel-header-activities">
                            ...
                            <div class="bmodel-cell-half border-top">
                                <div class="bmodel-header bmodel-header-resources">
                        ...
                        <div class="bmodel-cell border-start">
                            <div class="bmodel-header bmodel-header-value">
                        ...
                        <div class="bmodel-cell bmodel-cell-split border-start">
                            ...
                            <div class="bmodel-cell-half">
                                <div class="bmodel-header bmodel-header-relationship">
                            ...
                            <!-- Canais -->
                            <div class="bmodel-cell-half border-top">
                                <div class="bmodel-header bmodel-header-channels">
                                    <span>Canais</span>
                        ...
                        <div class="bmodel-cell border-start">
                            <div class="bmodel-header bmodel-header-segments">
                    ...
                    <div class="bmodel-bottom border-top">
                        ...
                        <!-- Estrutura de custos -->
                        <div class="bmodel-cell">
                            <div class="bmodel-header bmodel-header-costs">
                        ...
                        <!-- Fontes de receita -->
                        <div class="bmodel-cell border-start">
                            <div class="bmodel-header bmodel-header-revenue">
            ...
            <section class="resume-section">
                <h2 class="resume-section-title">Parcerias</h2>
